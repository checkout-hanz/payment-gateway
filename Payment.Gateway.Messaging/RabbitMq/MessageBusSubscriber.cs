...
namespace Payment.Gateway.Messaging.RabbitMq
{
    ...
    {
        private readonly IRabbitMQConfig _configuration;
        ...
        {
            var factory = new ConnectionFactory() { HostName = _configuration.Host, Port = _configuration.Port };
